...
const TrackShipment = ({ trackship }) => {
  const description = trackship.data.body[1].items[0].description;
  const title = trackship.data.body[1].items[0].title;
  const options = trackship.data.body[2].items;
  return (
    <>
